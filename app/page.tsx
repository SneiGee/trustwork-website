            ...
            {features.map((feature, index) => {
              ...
              return (
                <ScrollReveal key={index} animation="slide-up" delay={index * 100}>
                  <div className="p-8 bg-card border border-border rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300">
            ...
            <ScrollReveal animation="slide-right">
              <div>
                ...
                <p className="text-foreground/80 mb-6 leading-relaxed">
                  TRUSTWORK delivers integrated management, research and development solutions across multiple sectors
                  and geographies. Our approach combines professional expertise with deep industry knowledge.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal animation="scale">
            ...
            <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Let us help you achieve your strategic objectives through professional consulting and development
              services.
            </p>
            <Link
              href="/contact"
